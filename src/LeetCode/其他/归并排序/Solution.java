...
public class Solution {
    ...
    private void mergeOfTwoSortedArray(int[] nums, int left, int mid, int right, int[] temp) {
        ...
        System.out.println("left= "+left+" right= "+right+" k= "+k+" i= "+i+" j= "+j);
        while (i <= mid) {
            nums[k] = temp[i];
            k++;
            i++;
        ...
        System.out.println("排完之后: "+Arrays.toString(Arrays.copyOfRange(nums,left,right+1)));
    }

    public static void main(String[] args) {
        int[] a = {8, 6, 7, 2, 3, 5, 4, 1};
